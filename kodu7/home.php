...
?>
  ...
  <ul>
	...
	<li><a href="addfilmrelations.php">Filmi seoste valminine</a></li>
	<li><a href="listfilmpersons.php">Filmitegelased</a></li>
  <li><a href="addseosed.php">Filmi info lisamine</a></li>
  <li><a href="movieinfo.php">Filmi info näitamine</a></li>
  </ul>
  </ul>
